...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="w-full bg-[#EBE7DF] border-b border-[#CEBFA7] sticky top-0 z-40 select-none px-6 md:px-12 lg:px-16">
      {/* Top Announcement Bar */}
      {settings.announcement_text && (
        <div className="w-full bg-[#2D1A14] text-[#F8F8F2] font-accent text-center py-2 px-4 text-xs font-light tracking-wide -mx-6 md:-mx-12 lg:-mx-16 px-6 md:px-12 lg:px-16">
          {settings.announcement_text}
        </div>
      )}

      {/* Main Header Row - Matching Footer's max-w-[1440px] mx-auto 100% */}
      <div className="max-w-[1440px] mx-auto h-[80px] md:h-[90px] flex items-center justify-between">
          ...
          {!user ? (
            <>
              ...
              <button
                ...
                className="w-[149px] h-[40px] bg-[#C77065] text-[#F8F8F2] font-accent text-[16px] font-medium rounded-none flex items-center justify-center hover:bg-[#b05d52] transition-colors border-none cursor-pointer"
              >
