...
export const FilterDropdown: React.FC<FilterDropdownProps> = ({
  ...
  return (
    <div className={cn("relative inline-block min-w-[160px]", className)}>
      ...
      <select
        className="w-full pl-[65px] pr-9 py-2.5 bg-white border border-gray-light rounded-md text-xs font-sans text-text-dark font-medium shadow-sm outline-none appearance-none cursor-pointer focus:border-olive transition-colors duration-200"
        {...props}
      >
        {options.map((option) => (
