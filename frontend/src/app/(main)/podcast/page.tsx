      ...
      <div className="max-w-[1440px] mx-auto flex flex-col gap-10">
        ...
        <RevealOnScroll animation="zoom-in">
          <div className="bg-[#2D1A14] text-[#F8F8F2] p-8 md:p-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <button
              ...
              className="px-8 py-3.5 bg-[#C77065] text-[#F8F8F2] font-accent text-sm font-medium rounded-none btn-slide-hover border-none cursor-pointer flex-shrink-0 flex items-center gap-2"
            >
              <span>▶</span>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            {episodes.map((ep, idx) => (
              <RevealOnScroll key={ep.id} animation="fade-up" delay={idx * 150}>
                <div className="bg-[#EBE7DF] border border-[#CEBFA7] p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 bg-[#C77065] text-[#F8F8F2] font-accent text-xs font-medium rounded-none btn-slide-hover border-none cursor-pointer flex-shrink-0"
                  >
                    Play episode ▶
                  </button>
                </div>
