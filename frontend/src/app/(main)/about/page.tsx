    ...
    <div className="w-full bg-[#EBE7DF] py-12 px-6 md:px-12 lg:px-16">
      <div className="max-w-4xl mx-auto flex flex-col gap-12 items-center text-center">
        ...
        <div className="flex flex-col items-center gap-8 w-full">
          <RevealOnScroll animation="zoom-in" className="w-full max-w-2xl">
            <div className="w-full h-[420px] bg-[#D4C8B5] overflow-hidden relative border border-[#CEBFA7]">
              <img
          ...
          <RevealOnScroll animation="fade-up" delay={200}>
            <div className="flex flex-col gap-6 font-sans text-sm md:text-base text-[#2D1A14]/90 leading-relaxed text-left max-w-3xl">
              ...
              <div className="pt-2 text-center">
                <Link
                  href="/signup"
                  className="inline-block px-8 py-3.5 bg-[#C77065] text-[#F8F8F2] font-accent text-sm font-medium rounded-none btn-slide-hover text-decoration-none"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-[#CEBFA7]/40 pt-10 w-full text-left">
          <RevealOnScroll animation="fade-up" delay={100}>
            <div className="bg-[#EBE7DF] border border-[#CEBFA7] p-6 flex flex-col gap-3 h-full">
