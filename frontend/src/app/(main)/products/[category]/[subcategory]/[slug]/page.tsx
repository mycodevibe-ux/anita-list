...
export default function ProductDetail() {
  ...
  const slug = (params.slug as string) || "bugaboo-fox-5-renew";
  ...
  const productName = "Bugaboo Fox 5 Renew";
  const productPrice = "£00.00";
      ...
      <div className="max-w-[1440px] mx-auto flex flex-col gap-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="font-sans text-xs font-bold tracking-widest text-[#2D1A14] uppercase flex flex-wrap items-center gap-2 select-none">
            ...
            <span>|</span>
            <span className="text-[#2D1A14] font-extrabold">{productName.toUpperCase()}</span>
          </div>
